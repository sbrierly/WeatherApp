...
public class WeatherControllerTests
{
    ...
    public async Task Get_CurrentWeather_ReturnsOk()
    {
        ...
        // Act
        var result = await _controller.GetCurrentWeather(zipcode);
    ...
    public async Task Get_AverageForecast_ReturnsOk()
    {
        ...
        // Act
        var result = await _controller.GetAverageWeather(zipcode, days);
    ...
    [Fact]
    public async Task Get_AverageForecast_ZipcodeNotFound_ReturnsBadRequest()
    {
        // Arrange
        var zipcode = "99999";
        int days = 2;
        ...
        // Act
        var result = await _controller.GetAverageWeather(zipcode, days, TemperatureUnit.Fahrenheit);
